...
export const NavBar = () => {
  ...
  return (
    <div className="w-full md:h-[100px] h-[50px] xl:px-[144px] px-[15px] flex items-center justify-between border-b-2 bg-white">
          ...
          <DropdownMenuContent className="w-[300px] max-h-[600px] overflow-scroll">
            <DropdownMenuLabel className="flex justify-between text-lg tracking-widest">
              ...
              >
                <img
                  src={
                    "/imgs/nav-expand-arrow-" +
                    (expandMap === true ? "up" : "down") +
                    ".svg"
                  }
                  alt="expand"
                  width="15px"
            ...
            <div
              className={cn(
                { "max-h-[300px]": expandMap, "max-h-0": !expandMap },
                "overflow-scroll"
              )}
            >
            ...
            <div
              className={cn(
                { "max-h-[300px]": expandTopics, "max-h-0": !expandTopics },
                "overflow-scroll"
              )}
            >
              {topics.map((topic) => (
                ...
                >
                  ...
                  <nav className="ml-2">{topic.title}</nav>
                </DropdownMenuCheckboxItem>
              ))}
            </div>
          </DropdownMenuContent>
      ...
      <div
        className={cn(
          { "md:flex": pathname.startsWith("/en/home/search") },
          "w-[500px] hidden"
        )}
      >
      ...
      <div className="h-full md:flex items-center space-x-5 hidden">
        {/* home button */}
        <button
          className="w-[120px] h-[40px] flex items-center justify-center space-x-2 rounded-[30px] bg-[#D9D9D9]"
          onClick={() => {
            router.push("/home");
          }}
        >
      ...
      <div className="h-full flex items-center justify-center space-x-2 md:hidden">
        ...
        >
          <DrawerTrigger asChild>
            <button>
              <img
                src="/imgs/search-icon-black.svg"
                height="25px"
                alt="search-icon"
              />
            </button>
          ...
          <DrawerContent className="w-full h-full">
            <div className="flex px-5 mt-3 space-x-5">
              ...
              >
                <img src="/imgs/icon-back.svg" height="11px" alt="back" />
              </button>
              <SearchBar placeholder="default" topics={topics} />
            </div>
