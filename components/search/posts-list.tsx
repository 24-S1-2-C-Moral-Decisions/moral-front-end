...
export const PostsList = ({ topic }: { topic?: string }) => {
  ...
  return (
    <div
      className="space-y-5 h-full overflow-y-auto "
      ref={postListRef}
          ...
          <div className="mt-5 p-3 pl-5 space-y-2 hover:bg-[#EBEDEF] rounded-lg transition">
            ...
            <div
              className={cn(
                ...
                {
                  "max-h-0": !expandedPosts[post.title],
                  "max-h-[3000px]": expandedPosts[post.title],
                }
              )}
            >
              ...
              <div className="flex flex-col md:flex-row md:justify-evenly">
                <PostDoughnutChart
                  result={{
                    assholeNumber: post.assholeNumber,
                    notAssholeNumber: post.notAssholeNumber,
                    totalNumber: post.assholeNumber + post.notAssholeNumber,
                  }}
                />
                <PostAssholePanel
                  result={{
            ...
            <div className="flex items-center">
              <button
                className="w-[40px] h-[25px] bg-gray-200 rounded-2xl flex justify-center items-center"
              ...
              <div
                className={cn(
                  "ml-3 w-[120px] h-[25px] bg-gray-500 rounded-[30px] flex items-center justify-center text-white text-sm font-bold",
                  {
                    "bg-[#5E7BFE]": post.verdict === "NTA",
                    "bg-[#A80018]": post.verdict === "YTA",
                  }
                )}
              >
                {post.verdict}
